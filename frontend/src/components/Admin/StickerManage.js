        ...
        <>
            ...
            <table className="table-sticker-wrap table-display-data-wrap">
                ...
                <tr className="table-sticker-head-row table-display-data-head-row">
                    <th className="table-sticker-head-cell table-display-data-head-cell" style={{width: "15%"}}>Image</th>
                    <th className="table-sticker-head-cell table-display-data-head-cell" style={{width: "15%"}}>Name</th>
                    <th className="table-sticker-head-cell table-display-data-head-cell" style={{width: "15%"}}>Category</th>
                    <th className="table-sticker-head-cell table-display-data-head-cell" style={{width: "20%"}}>Created At</th>
                    <th className="table-sticker-head-cell table-display-data-head-cell" style={{width: "20%"}}>Updated At</th>
                    <th className="table-sticker-head-cell table-display-data-head-cell" style={{width: "20%"}}>Action</th>
                </tr>
                </thead>
                ...
                {stickerData.map((sticker) => (
                    <tr key={sticker.id} className="table-sticker-body-row table-display-data-body-row">
                        <td className="table-sticker-body-cell table-display-data-body-cell" style={{width: "15%", textAlign: "center"}}>
                            <img src={sticker.sticker_file} alt={sticker.name}/>
                        </td>
                        <td className="table-sticker-body-cell table-display-data-body-cell" style={{width: "15%"}}>{sticker.name}</td>
                        <td className="table-sticker-body-cell table-display-data-body-cell" style={{width: "15%"}}>{sticker.category}</td>
                        <td className="table-sticker-body-cell table-display-data-body-cell" style={{width: "20%", textAlign: "center"}}>{new Date(sticker.created_at).toLocaleString()}</td>
                        <td className="table-sticker-body-cell table-display-data-body-cell" style={{width: "20%", textAlign: "center"}}>{new Date(sticker.updated_at).toLocaleString()}</td>
