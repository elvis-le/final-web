        ...
        <>
            ...
            <table className="table-text-wrap table-display-data-wrap">
                ...
                <tr className="table-text-head-row table-display-data-head-row">
                    ...
                    <th className="table-text-head-cell table-display-data-head-cell" style={{width: "10%"}}>Content</th>
                    <th className="table-text-head-cell table-display-data-head-cell" style={{width: "10%"}}>Category</th>
                    <th className="table-text-head-cell table-display-data-head-cell" style={{width: "10%"}}>Text File</th>
                    <th className="table-text-head-cell table-display-data-head-cell" style={{width: "15%"}}>Created At</th>
                    <th className="table-text-head-cell table-display-data-head-cell" style={{width: "15%"}}>Updated At</th>
                ...
                {textData.map((text) => (
                    <tr key={text.id} className="table-text-body-row table-display-data-body-row">
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "10%", textAlign: "center"}}>
                            <img src={text.image} alt={text.content}/>
                        </td>
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "10%"}}>{text.name}</td>
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "10%", textAlign: "center"}}>{text.content}</td>
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "10%"}}>{text.category}</td>
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "10%", textAlign: "center"}}>
                            <a href={text.text_file} target="_blank" rel="noopener noreferrer">File link</a>
                        </td>
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "20%"}}>{new Date(text.created_at).toLocaleString()}</td>
                        <td className="table-text-body-cell table-display-data-body-cell" style={{width: "20%"}}>{new Date(text.updated_at).toLocaleString()}</td>
