        ...
        <>
            ...
            <table className="table-filter-wrap table-display-data-wrap">
                ...
                <tr className="table-filter-head-row table-display-data-head-row">
                    <th className="table-filter-head-cell table-display-data-head-cell" style={{width: "15%"}}>Image
                    </th>
                    <th className="table-filter-head-cell table-display-data-head-cell" style={{width: "15%"}}>Name</th>
                    <th className="table-filter-head-cell table-display-data-head-cell"
                        style={{width: "15%"}}>Category
                    </th>
                    <th className="table-filter-head-cell table-display-data-head-cell" style={{width: "20%"}}>Created
                        At
                    </th>
                    <th className="table-filter-head-cell table-display-data-head-cell" style={{width: "20%"}}>Updated
                        At
                    </th>
                    <th className="table-filter-head-cell table-display-data-head-cell" style={{width: "20%"}}>Action
                    </th>
                </tr>
                </thead>
                ...
                {filterData.map((filter) => (
                    <tr key={filter.id} className="table-filter-body-row table-display-data-body-row">
                        <td className="table-filter-body-cell table-display-data-body-cell"
                            style={{width: "15%", textAlign: "center"}}>
                            <img src={filter.image} alt={filter.name}/>
                        </td>
                        <td className="table-filter-body-cell table-display-data-body-cell"
                            style={{width: "15%"}}>{filter.name}</td>
                        <td className="table-filter-body-cell table-display-data-body-cell"
                            style={{width: "15%"}}>{filter.category}</td>
                        <td className="table-filter-body-cell table-display-data-body-cell"
