        ...
        <>
            ...
            <table className="table-effect-wrap table-display-data-wrap">
                ...
                <tr className="table-effect-head-row table-display-data-head-row">
                    <th className="table-effect-head-cell table-display-data-head-cell" style={{width: "10%"}}>Image</th>
                    <th className="table-effect-head-cell table-display-data-head-cell" style={{width: "20%"}}>Name</th>
                    <th className="table-effect-head-cell table-display-data-head-cell" style={{width: "20%"}}>Category</th>
                    <th className="table-effect-head-cell table-display-data-head-cell" style={{width: "20%"}}>Created At</th>
                    <th className="table-effect-head-cell table-display-data-head-cell" style={{width: "20%"}}>Updated At</th>
                    <th className="table-effect-head-cell table-display-data-head-cell" style={{width: "20%"}}>Action</th>
                </tr>
                </thead>
                ...
                {effectData.map((effect) => (
                    <tr key={effect.id} className="table-effect-body-row table-display-data-body-row">
                        <td className="table-effect-body-cell table-display-data-body-cell" style={{width: "10%", textAlign: "center"}}>
                            <img src={effect.image} alt={effect.name}/>
                        </td>
                        <td className="table-effect-body-cell table-display-data-body-cell" style={{width: "20%"}}>{effect.name}</td>
                        <td className="table-effect-body-cell table-display-data-body-cell" style={{width: "20%", textAlign: "center"}}>{effect.category}</td>
                        <td className="table-effect-body-cell table-display-data-body-cell" style={{width: "20%", textAlign: "center"}}>
